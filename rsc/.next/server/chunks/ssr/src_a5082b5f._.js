...
"[project]/src/hooks/use-event-api.ts [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2d$instance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/axios-instance.ts [app-ssr] (ecmascript)");
'use client';
;
;
const fetcher = (url)=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2d$instance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get(url).then((res)=>res.data);
const EVENTS_URL = '/events';
const useEvents = ()=>{
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(EVENTS_URL, fetcher);
    return {
        events: data,
        isLoading,
        error: error,
...
const useEvent = (id)=>{
    const { data, error, isLoading, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])(`${EVENTS_URL}/${id}`, fetcher);
    return {
        event: data,
        isLoading,
        error: error,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2d$instance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/axios-instance.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$event$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/use-event-api.ts [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const DeleteEvent = ({ eventId, children })=>{
    const { mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$use$2d$event$2d$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEvents"])();
    const handleDelete = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$axios$2d$instance$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`/events/${eventId}`);
...
//# sourceMappingURL=src_a5082b5f._.js.map